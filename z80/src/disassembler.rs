use crate::instruction::{Opcode, Operand, Register, Instruction, Immediate, Condition};
    ...
    fn decode_opcode(&self, offset: usize, prefix: Option<u8>, opcode: u8) -> Opcode {
        match (prefix, opcode) {
            ...
            (None, 0x11) => Opcode::Load(
                Operand::Register(Register::DE, false),
                Operand::Immediate(Immediate::U16(self.read_u16(offset + 1)), false),
                3),
            ...
            (None, 0x14) => Opcode::Increment(
                Operand::Register(Register::D, false),
                1),
            ...
            (None, 0x1a) => Opcode::Load(
                Operand::Register(Register::A, false),
                Operand::Register(Register::DE, true),
                1),
            ...
            (None, 0x21) => Opcode::Load(
                Operand::Register(Register::HL, false),
                Operand::Immediate(Immediate::U16(self.read_u16(offset + 1)), false),
                3),
            ...
            (None, 0x24) => Opcode::Increment(
                Operand::Register(Register::H, false),
                1),
            ...
            (None, 0x31) => Opcode::Load(
                Operand::Register(Register::SP, false),
                Operand::Immediate(Immediate::U16(self.read_u16(offset + 1)), false),
                3),
            ...
            (None, 0x43) => Opcode::Load(
                Operand::Register(Register::B, false),
                Operand::Register(Register::E, false),
                1),
            ...
            (None, 0x45) => Opcode::Load(
                Operand::Register(Register::B, false),
                Operand::Register(Register::L, false),
                1),
            (None, 0x46) => Opcode::Load(
                Operand::Register(Register::B, false),
                Operand::Register(Register::HL, true),
                1),
            ...
            (Some(0xed), 0x79) => Opcode::Out(
                Operand::Register(Register::C, true),
                Operand::Register(Register::A, false),
                2),
